...
const testimonials = [
  {
    name: "Hotel Mitologia",
    username: "Pará",
    body: "Acordei com 3 reservas confirmadas. Sem tocar no celular. Sem perder tempo.",
    img: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Canastra Woods",
    username: "Serra da Canastra",
    body: "Os hóspedes acham que é gente. E eu? Durmo tranquilo sem celular do lado.",
    img: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Pousada Vista Mar",
    username: "Bahia",
    body: "Clara responde mais rápido que eu e nunca esquece de nada. Melhor investimento que fiz.",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Hotel Boutique SP",
    username: "São Paulo",
    body: "Integração com Cloudbeds funcionou perfeitamente. Reservas automáticas todos os dias.",
    img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Pousada do Vale",
    username: "Minas Gerais",
    body: "Antes perdia reservas de madrugada. Agora acordo com WhatsApp cheio de confirmações.",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Chalés da Serra",
    username: "Rio Grande do Sul",
    body: "Clara atende melhor que muito recepcionista humano. E nunca tira férias.",
    img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Resort Tropical",
    username: "Ceará",
    body: "Suporte da equipe é excelente. Configuraram tudo em menos de uma semana.",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Pousada Recanto",
    username: "Espírito Santo",
    body: "Minha equipe está menos sobrecarregada e eu tenho mais tempo para cuidar dos hóspedes.",
    img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Hotel Fazenda",
    username: "Goiás",
    body: "ROI positivo no primeiro mês. Clara já se pagou várias vezes.",
        ...
        <div className="mx-auto max-w-[540px]">
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="relative text-white">Depoimentos</span>
            </button>
          </div>
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            Clara já está trabalhando e vendendo para pousadas e hotéis em todo o Brasil
          </p>
        </div>
